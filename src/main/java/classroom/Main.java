...
public class Main {
    public static void main(String[] args) {
        ...
        //(mainīgā tips) (mainīgā nosukums) = (vērtība) ;
        double dogWeight = 15.8; //daļskaitlis
        float augumsSuns = 60.23F; //daļskaitlis
        ...
        System.out.println("Mans suņa augstums" + " " +augumsSuns + " cm");
